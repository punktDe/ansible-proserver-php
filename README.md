<!-- BEGIN_ANSIBLE_DOCS -->
# Ansible Role: ansible-proserver-php
...
Main entry point for the PHP role
...
|---|---|---|---|---|
| php |  | dict of 'php' options | yes |  |

#### Options for main > php
...
#### Options for main > php > repository

|Option|Description|Type|Required|Default|
|---|---|---|---|---|
| apt |  | dict of 'apt' options | yes |  |

#### Options for main > php > repository > apt
...
#### Options for main > php > phpfpmtop

|Option|Description|Type|Required|Default|
|---|---|---|---|---|
| release |  | dict of 'release' options | no |  |

#### Options for main > php > phpfpmtop > release
...
#### Options for main > php > modules > disable
...
- hosts: all
  tasks:
    - name: Importing role: ansible-proserver-php
      ansible.builtin.import_role:
        name: ansible-proserver-php
      vars:
        php: # required, type: dict of 'php' options
```
